...
- Mode "Buat Gambar" — text-to-image lewat Pollinations (gratis, tanpa API key), Gemini Nano Banana 2, atau Hugging Face FLUX.1 Dev
...
- `HF_TOKEN` — wajib kalau mau pakai FLUX.1 Dev di mode gambar (buat gratis di huggingface.co/settings/tokens, pilih token tipe "Read")
